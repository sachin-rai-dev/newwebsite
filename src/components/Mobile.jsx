  ...
  let [mshow,setmshow]=useState(false);
    ...
    <div className="main-xyz">
          <div className="menu-des" onClick={()=>setmshow(!mshow)}>
            <span>Type: Mobile app</span> <span className={`image-arrow ${mshow ? 'active' : '' }`}>
          ...
          <div className='p-links'>
            <ul>
                ...
                <li id="li"><Link to={'/Mobile'}> Mobile app</Link></li>
            </ul>
        </div>
          </div>
        </div>
        ...
        <div className='p-links p-links-computer'>
            <ul>
                ...
                <li><Link to={'/webapp'}> Web app</Link></li>
                <li><Link to={'/Branding'}>Branding</Link> </li>
                <li className="li1"><Link to={'/Mobile'}> Mobile app</Link></li>
            </ul>
        </div>
        <hr className="hrr" />
